...
config = Config({
    ...
    # data
    'image_path': 'E:/dataset/AVA/images',  # directory to images (Set your path)
    'text_csv_path': 'D:/paper code/ava_comment.csv',  # directory to texts (Set your path)
    ...
    'MIGF_model_path': '../Checkpoint/AVA/new-epoch_1_SignificanceResult(statistic=0.8421)_PearsonRResult(statistic=0.8554)_val_loss_0.0360_.pt', # (Set your path)
    ...
    'save_path': '../Checkpoint/AVA',  # directory for saving checkpoint (Set your path)
})